...
return [
    ...
    'note_modal' => [
        'files_shared_hint' => 'Файлы можно прикрепить только к внутренней заметке - портал самообслуживания не может их показать. Снимите отметку общего доступа, если нужно прикрепить файл.',
    ...
    'note_visibility' => [
        'internal'       => 'Внутренняя',
        'internal_title' => 'Это видят только коллеги. В портале самообслуживания не показывается.',
        'shared'         => 'Видна заявителю',
        'shared_title'   => 'Заявитель может прочитать это в портале самообслуживания.',
    ],
];
