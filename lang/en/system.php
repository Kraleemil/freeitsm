...
return [
    ...
    'sso' => [
        ...
        'sync_attrs'           => 'Where each detail comes from',
        'sync_attrs_hint'      => 'Leave blank to use the standard names for your directory type. Job title, department, office, phone, mobile, employee number, manager.',
