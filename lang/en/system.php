...
return [
    ...
    'sso' => [
        ...
        'field_ldap_attrs'     => 'Attribute names',
        'field_ldap_attrs_hint'=> 'Sign-in name, email, display name and unique id. Leave blank to use the standard names for your directory type.',
