<?php
/**
 * API Endpoint: Save asset type (create or update) — multi-tenancy aware.
 *
 * Context decides scope (mirrors save_ticket_type.php, design §7):
