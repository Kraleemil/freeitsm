...
$module_title = function_exists('t') ? t('service-status.title') : 'Service Status';
...
<div class="header service-status-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo BASE_URL; ?>service-status/" class="nav-btn <?php echo $current_page === 'dashboard' ? 'active' : ''; ?>" title="<?php echo htmlspecialchars(function_exists('t') ? t('service-status.nav.status') : 'Status'); ?>">
        ...
        <a href="<?php echo BASE_URL; ?>service-status/settings/" class="nav-btn <?php echo $current_page === 'settings' ? 'active' : ''; ?>" title="<?php echo htmlspecialchars(function_exists('t') ? t('service-status.nav.settings') : 'Settings'); ?>">
            ...
            <span><?php echo htmlspecialchars(function_exists('t') ? t('service-status.nav.settings') : 'Settings'); ?></span>
        </a>
        <a href="<?php echo BASE_URL; ?>service-status/help.php" class="nav-btn <?php echo $current_page === 'help' ? 'active' : ''; ?>" title="<?php echo htmlspecialchars(function_exists('t') ? t('service-status.nav.help') : 'Help'); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="12" cy="12" r="10"></circle>
                <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path>
                <line x1="12" y1="17" x2="12.01" y2="17"></line>
            </svg>
            <span><?php echo htmlspecialchars(function_exists('t') ? t('service-status.nav.help') : 'Help'); ?></span>
        </a>
    </nav>
