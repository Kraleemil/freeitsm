...
function documentsPanelAssets(string $pathPrefix = '../'): void
{
    ...
    if ($emitted) return;
    $emitted = true;
    echo '<link rel="stylesheet" href="' . htmlspecialchars($pathPrefix) . 'assets/css/documents.css?v=1">' . "\n";
    echo '<script src="' . htmlspecialchars($pathPrefix) . 'assets/js/documents.js?v=1"></script>' . "\n";
}
