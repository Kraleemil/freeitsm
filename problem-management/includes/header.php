<?php
/**
 * Problem Management module header (mirrors change-management/includes/header.php).
 * Set $current_page before including.
 */
$path_prefix = $path_prefix ?? '../';
$current_module = 'problems';
...
<div class="header problems-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo BASE_URL; ?>problem-management/" class="nav-btn <?php echo $current_page === 'problems' ? 'active' : ''; ?>" title="Problems">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
            <span>Problems</span>
        </a>
        <a href="<?php echo BASE_URL; ?>problem-management/settings/" class="nav-btn <?php echo $current_page === 'settings' ? 'active' : ''; ?>" title="Settings">
        ...
        <a href="<?php echo BASE_URL; ?>problem-management/help.php" class="nav-btn <?php echo $current_page === 'help' ? 'active' : ''; ?>" title="Help">
